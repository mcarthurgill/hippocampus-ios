...
- (void) setupProperties {
    ...
    UIBarButtonItem *randButton = [[UIBarButtonItem alloc] initWithTitle:@"Random"
...
- (void) askServerForRandomItemsWithLimit:(int)limit {
    requestMade = YES;
    [[LXServer shared] requestPath:@"/random_items.json" withMethod:@"GET" withParamaters: @{ @"user_id": [[HCUser loggedInUser] userID], @"limit": [NSString stringWithFormat:@"%d", limit]}
